      ...
      <div class="pc-content">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body bg-white">
                        <form method="POST" action="{{ route('anneescolaires.update', $anneescolaire->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
                                    ...
                                    <div class="grid grid-cols-12 gap-3 mb-3">
                                        ...
                                        <div class="col-span-12 xl:col-span-4 md:col-span-6">
                                                ...
                                                <select name="anneear" class="form-select @error('anneear') is-invalid @enderror" id="anneear">
                                                        <option value="{{ old('anneear', $anneescolaire?->anneear) }}">{{ $anneescolaire?->anneear }}</option>
